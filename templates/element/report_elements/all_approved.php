								...
								<table class="table table-sm rounded table-bordered" id="approved_applications_report_table">
									<thead class="table-light">
										<tr class="rounded">
											...
											<th><span class="table-heading">Name of the State</span></th>
											<th><span class="table-heading">Name of the RO</span></th>
											<th><span class="table-heading">Name of the Firm</th>
											<th><span class="table-heading">Address of the Firm</th>
											<th><span class="table-heading">e-mail ID</span></th>
											<th><span class="table-heading">Contact Details</span></th>
											<th><span class="table-heading">Process</span></th>
											<th><span class="table-heading">Customer ID</span></th>
											<th><span class="table-heading">Issued on</span></th>
											<th><span class="table-heading">Valid upto</span></th>
										...
										<?php //Find and calculate the value for Sr.No column (Done by pravin 16-07-2018)
											...
											for ($i=0; $i<sizeof($date); $i++) { ?>
												...
												<tr id="table_row" class="row-hover border border-light">
													...
													<td><span class="badge subtitle borderless"><?php echo $state_name[$i];?></span></td>
													<td><span class="badge subtitle borderless"><?php echo $user_office[$i]; ?></span></td>
													<td><span class="badge subtitle borderless"><?php echo $name_of_the_firm[$i]; ?></span></td>
													<td><span class="badge subtitle borderless"><?php echo $address_of_the_firm[$i]; ?></span></td>
													<td><span class="badge subtitle borderless"><?php echo $contact_details_of_the_firm[$i]; ?></span></td>
													<td><span class="badge subtitle borderless"><?php echo base64_decode($phoneno[$i]); ?></span></td>
													...
													<td><span class="badge subtitle borderless"><?php echo $issued_on[$i];?></span></td>
													<td><span class="badge subtitle borderless"><?php echo $valid_upto[$i];?></span></td>
													...
													<?php if ($approved_TBL_details_tbl_name[$i][0] == 'N/A') { ?>
														<td>N/A</td>
													<?php }else{ ?>
													...
													<?php if ($laboratory_details_name[$i] == 'N/A') { ?>
														<td>N/A</td>
													<?php }else{ ?>
