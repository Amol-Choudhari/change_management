<div class="content-wrapper">
    <section id="applicanthome" class="content">
        ...
        <?php  if(!empty($appl_adp_pdfs_records)) { ?>
          <section class="col-lg-12 connectedSortable">
            <div class="card card-info">
              <div class="card-header"><h3 class="card-title-new">Application Pdf for Add/Delete of Designated persons</h3></div>
                <div class="card-body">
                  <table id="example2" class="table m-0 table-bordered">
                    <thead class="tablehead">
                      <tr>
        ...
        <?php } ?>
         ...
         <?php  if(!empty($appl_adp_grant_pdfs)) { ?>
          <section class="col-lg-12 connectedSortable">
            <div class="card card-info">
              <div class="card-header"><h3 class="card-title-new">Grant Certificate Pdf for Add/Delete of Designated persons</h3></div>
                <div class="card-body">
                  <table id="example2" class="table m-0 table-bordered">
                    <thead class="tablehead">
                      <tr>
		...
		<!-- to show appli pdf list for change/modification on 13-12-2022 by Amol  -->
