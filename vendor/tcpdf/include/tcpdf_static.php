...
class TCPDF_STATIC {
	...
	* @since 5.9.121 (2011-09-28)
	...
	public static function getFormattedDate($time) {
		...
		//added this line to get timestamp of after 8 minutes, in pdf_add_annotation
		//to fit the time in certificate validity of 30 minutes, while adding signature.
		//by Amol on 04-02-2020
		$time = strtotime("+3 minutes", $time);
		$_SESSION['sign_timestamp'] = date('d/m/Y H:i:s',$time);//to be used in Signed by block on pdf.
