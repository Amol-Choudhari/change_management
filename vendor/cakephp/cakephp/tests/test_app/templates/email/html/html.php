...
<th align="right" valign="top"
        style="font-weight: bold">The tag is across multiple lines - <?= str_repeat('x', Message::LINE_LENGTH_MUST); ?></th>
</table>
<p>Some more <?= str_repeat('x', Message::LINE_LENGTH_MUST); ?> <b>Bold</b> test.</p>
